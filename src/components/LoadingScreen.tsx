      ...
      {!isLoaded && (
        ...
        >
          <div className="flex flex-col items-center">
            ...
            >
              <div className="w-12 h-12 border-2 border-[#D4AF37] flex items-center justify-center rounded-sm mb-4 shadow-lg shadow-[#D4AF37]/10">
                <span className="text-[#D4AF37] font-bold text-2xl font-cinzel">A</span>
              </div>
